  ...
  return (
    <>
      ...
      <Figure
        ...
        caption="Each step up the ladder is ×10 in energy. The span from a background A-class to a great X-class flare covers four orders of magnitude, a 10,000x dynamic range."
      >
        <FlareLadder />
      </Figure>
      ...
      <Callout kind="warn" title="The dynamic-range requirement, stated plainly">
        ...
        <em>and</em> a giant X-class flare that saturates a sensitive detector, a 10,000x range. This is precisely
