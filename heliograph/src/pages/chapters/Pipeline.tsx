  ...
  return (
    <>
      ...
      <Callout kind="key" title="Streaming vs batch — the same code path">
        ...
        deployed — no train/serve skew. The dashboard's "replay" mode is literally the batch path driving the
        streaming UI.
      </Callout>

      <p>
        With the flow clear, the next two chapters open the two engines this pipeline forks into — the classical
        nowcaster and the hybrid forecaster — and argue, in detail, why each is built the way it is.
      </p>
    </>
  );
}
