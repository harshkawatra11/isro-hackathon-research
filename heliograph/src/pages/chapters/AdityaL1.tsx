  ...
  return (
    <>
      ...
      <p>
        ...
        1.5 million km from Earth directly toward the Sun — only ~1% of the way to the Sun, but far enough to escape
      ...
      <Callout kind="key" title="Where we go next">
        We only need SoLEXS and HEL1OS — so the next chapter opens them up: their detectors, their energy bands, and
