  ...
  return (
    <>
      ...
      <p>
        ...
        It arrives in three waves; only the first one travels at the speed of light.
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <Card icon="🌀" title="3 · Coronal mass ejection" accent="#a78bfa">
          A billion-tonne magnetised plasma cloud, <strong>1–3 days</strong> in transit. When it hits Earth's
