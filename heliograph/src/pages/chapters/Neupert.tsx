...
export default function Neupert() {
  return (
    <>
      ...
      <h3 className="prose-h3">Two horizons: intellectual honesty about both</h3>
      <p>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-xl border border-line bg-panel p-4" style={{ borderLeft: "4px solid #34d399" }}>
          ...
          <p className="mt-1 text-[14px] text-muted">
            ...
            the upcoming soft-X-ray peak, giving minutes of genuine warning on the most damaging moment. This is our
