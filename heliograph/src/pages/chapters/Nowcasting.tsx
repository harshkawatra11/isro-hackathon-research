  ...
  return (
    <>
      ...
      <ol className="ml-5 list-decimal text-ink/90">
        ...
        <li><strong>Persistence / hysteresis.</strong> Require the condition to hold for several seconds to start an event, and to clearly drop before ending it, preventing single-sample glitches and an event from flickering on and off.</li>
      </ol>
      <p>
      ...
      <Callout kind="good" title="Deliverable #1, done: no GPU needed">
